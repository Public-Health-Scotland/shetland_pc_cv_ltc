  ...
  left_join(
    quarterly_event_type |>
      pivot_wider(
        ...
        values_from = proportion_quarterly_event_type,
        values_fill = 0.0
      ),
...
cv_prev_plotly <- plot_ly(
  ...
  x = ~census_date,
  y = ~proportion_list_LTC_prevalence,
  color = ~PracticeID,
  symbol = ~PracticeID,
  ...
  text = ~ paste(
    ...
    "<br>CV Prevalence:", percent(proportion_list_LTC_prevalence, accuracy = 0.1),
...
cv_prev_dt <- make_dt(
  ...
  main_var = "proportion_list_LTC_prevalence",
...
cv_ctac_1_plotly <- plot_ly(
  ...
  text = ~ paste(
    "Practice:", PracticeID, 
    "<br>Month:", census_date,
    "<br>Invite percentage:", percent(proportion_LTC_invite, accuracy = 0.1)
    )
) |>
  layout(
...
cv_ctac_1_dt <- make_dt(
  shared_data = shared_monthly_summary,
  main_var = "proportion_LTC_invite",
...
cv_ctac_2_plotly <- plot_ly(
  ...
  text = ~ paste(
    "Practice:", PracticeID,
    "<br>Month:", census_date,
    "<br>Attend percentage:", percent(proportion_LTC_attend, accuracy = 0.1)
    )
) |>
  layout(
...
cv_ctac_2_dt <- make_dt(
  shared_data = shared_monthly_summary,
  main_var = "proportion_LTC_attend",
...
cv_ctac_3_plotly <- plot_ly(
  shared_monthly_summary,
  x = ~census_date,
  y = ~proportion_first_invite_LTC_attend,
  color = ~PracticeID,
  symbol = ~PracticeID,
  colors = practice_colours,
  symbols = practice_symbols,
  ...
  text = ~ paste(
    ...
    "<br>Attend percentage:", percent(proportion_first_invite_LTC_attend, accuracy = 0.1)
  )
) |>
  layout(
...
cv_ctac_3_dt <- make_dt(
  shared_data = shared_monthly_summary,
  main_var = "proportion_first_invite_LTC_attend",
  main_name ="Attend percentage",
  other_vars = "ltc_first_invite_count",
  other_names = "Invites sent",
  percentage = TRUE
)
```
...
cv_ctac_4_plotly <- plot_ly(
  shared_monthly_summary,
  x = ~census_date,
  y = ~proportion_first_attend_HOC_sent,
  color = ~PracticeID,
  symbol = ~PracticeID,
  colors = practice_colours,
  symbols = practice_symbols,
  ...
  text = ~ paste(
    ...
    "<br>HoC sent percentage:", percent(proportion_first_attend_HOC_sent, accuracy = 0.1)
  )
) |>
  layout(
...
cv_ctac_4_dt <- make_dt(
  shared_data = shared_monthly_summary,
  main_var = "proportion_first_attend_HOC_sent",
...
pharm_6_plotly <- plot_ly(
  shared_monthly_summary,
  x = ~census_date,
  y = ~proportion_pharmacist_reviews,
  color = ~PracticeID,
  symbol = ~PracticeID,
  colors = practice_colours,
  symbols = practice_symbols,
  ...
  text = ~ paste(
    "Practice:", PracticeID,
    "<br>Month:", census_date,
    "<br>Percentage by pharmacist:", percent(proportion_pharmacist_reviews, accuracy = 0.1))
) |>
  layout(
...
pharm_6_dt <- make_dt(
  shared_data = shared_monthly_summary,
  main_var = "proportion_pharmacist_reviews",
  ...
  group_map(
    \(practice_data, practice_id) {
      ...
      plot_ly(
        data = practice_data,
        x = ~quarter_start,
        y = ~proportion_quarterly_event_type,
        ...
        text = ~ paste(
          ...
          "<br>Percentage:", round(proportion_quarterly_event_type * 100, 1), "%"
        ),
...
pharma1_90_plotly <- plot_ly(
  ...
  text = ~ paste(
    "Practice:", PracticeID,
    "<br>Month:", census_date,
    "<br>Proportion Reviewed (90 days):", percent(proportion_pharma_review_90, accuracy = 0.1)
    )
) |>
  layout(
...
pharma1_90_dt <- make_dt(
  shared_data = shared_monthly_summary,
  main_var = "proportion_pharma_review_90",
...
pharma1_180_plotly <- plot_ly(
  shared_monthly_summary,
  x = ~census_date,
  y = ~proportion_pharma_review_180,
  color = ~PracticeID,
  symbol = ~PracticeID,
  colors = practice_colours,
  symbols = practice_symbols,
  ...
  text = ~ paste(
    "Practice:", PracticeID,
    "<br>Month:", census_date,
    "<br>Proportion Reviewed (180 days):", percent(proportion_pharma_review_180, accuracy = 0.1))
) |>
  layout(
...
pharma1_180_dt <- make_dt(
  shared_data = shared_monthly_summary,
  main_var = "proportion_pharma_review_180",
...
percentage_styling <- createStyle(numFmt = "0.0%")

for (sheet_name in names(all_data_frames)) {
  addWorksheet(wb, sheet_name)
  percentage_cols <- which(str_starts(colnames(all_data_frames[[sheet_name]]), "proportion_"))
  addStyle(
    wb = wb, 
    sheet = sheet_name, 
    style = percentage_styling, 
    rows = seq_len(nrow(all_data_frames[[sheet_name]])) + 1,
    cols = percentage_cols,
    gridExpand = TRUE
    )
  setColWidths(wb, sheet = sheet_name, cols = seq_len(ncol(all_data_frames[[sheet_name]])), widths = "auto")
  writeDataTable(wb, sheet_name, all_data_frames[[sheet_name]])
}
